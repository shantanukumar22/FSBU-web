...
//             {/* Details Section with Avatar-style Images */}
//             <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
//               <div className="absolute bg-s3/20 top-[38%] left-0 right-0 w-full h-[1px] z-10" />
...
//                   <div className="flex items-center justify-center mx-auto mb-3 border-2 border-s2 rounded-full hover:border-s4 transition-all duration-500 shadow-500 size-24">
//                     {/* Avatar-style Image */}
//                     <img
//                       src={icon}
//                       alt={title}
//                       className="w-16 h-16 object-cover rounded-full z-20"
//                     />
//                   </div>
          ...
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {features.map(({ id, icon, caption, title, text, button }) => (
              ...
              >
                <div className="w-full flex justify-start items-start">
                  <div className="-ml-3 mb-12 flex items-center justify-center flex-col">
                    <div className="w-full h-0.5 bg-s3" />

                    {/* Image with full width and reduced height */}
                    <img
                      src={icon}
                      className="w-[500px] h-[200px] object-cover" // Full width, fixed height
                      alt={title}
                    />
                  </div>
                </div>
