export const features = [
  {
    id: 1,
    icon: "/images/features1.jpg",
    caption: "Learn and Build",
    title: "Collaborative Learning",
    text: "Work on real-world projects with fellow Fullstack enthusiasts and hone your skills through hands-on experience.",
    button: { title: "Always here to Help", icon: "/images/circle.svg" },
  },
  {
    id: 2,
    ...
    caption: "Hackathons",
    title: "Compete & Win",
    text: "Participate in coding competitions and hackathons to showcase your skills and earn exciting prizes.",
    button: { title: "Register Now", icon: "/images/triangle.svg" },
  },
  // {
  //   id: 3,
  //   icon: "/images/icon-3.svg",
  //   caption: "Workshops & Talks",
  //   title: "Industry Talks",
  //   text: "Learn from experts in the tech industry through workshops and live talks on the latest technologies.",
  //   button: { title: "Learn More", icon: "/images/learn.svg" },
  // },
];
...
export const faq = [
  {
    id: "0",
    question: "What is the FullStack Club all about?",
    answer:
      "The FullStack Club is a community where like-minded individuals come together to learn, grow, and collaborate on projects across various tech domains, from front-end to back-end. We aim to provide opportunities for hands-on learning and real-world applications.",
  },
  {
    id: "1",
    question: "What kind of events do you organize",
    answer:
      "We host a variety of events, including workshops, hackathons, webinars, and project showcases. Our events cover diverse topics ranging from web development to team collaboration, and we focus on providing hands-on experience.",
  },
  {
    id: "2",
    question: " How do I stay updated on upcoming events and activities?",
    answer:
      "We keep our members informed through regular newsletters, social media updates, and our website’s event calendar. Be sure to follow us on social media and sign up for our email list to never miss an event or opportunity!",
  },
  {
    id: "3",
    question:
      " Do you offer any certification or recognition for participation?",
    answer:
      "Yes, we offer recognition for active participation and contributions. Whether it’s through certificates for event participation or recognition for your role in projects, we ensure that your efforts are acknowledged and celebrated",
  },
  {
    id: "4",
    question: "Can I collaborate with others on projects?",
    answer:
      "Absolutely! Collaboration is one of the core aspects of the FullStack Club. We encourage members to work together on group projects, share knowledge, and help each other grow through teamwork.",
  },
  {
    id: "5",
    question: "What skills can I expect to learn in the FullStack Club?",
    answer:
      "you’ll have the opportunity to learn a wide range of skills, including web development, design principles, project management, team collaboration, and problem-solving techniques. Whether it’s front-end, back-end, or full-stack development, there’s always something new to explore!",
  },
  {
    id: "6",
    question: "Can I get help with my personal projects?",
    answer:
      "Definitely! The FullStack Club is a great place to get support on your personal projects. Whether you need advice on code, feedback on design, or help with a technical challenge, our members and mentors are always willing to lend a hand.",
  },
  {
    id: "7",
    question: "What makes the FullStack Club unique?",
    answer:
      "The FullStack Club is unique because it not only focuses on full-stack development but also fosters a collaborative and inclusive environment where members can learn, grow, and create together. We emphasize hands-on experience, teamwork, and community involvement, making it a great space for personal and professional development.",
  },
];
...
export const plans = [
  ...
  {
    id: "1",
    title: "FullStack Classes",
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Learn Mern stack with us",
    features: [
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Wanna Desgin ? we got you.",
    features: [
      "Principle concepts of web design",
      "Figma Interface",
      "Projects",
      "Goodies ofc",
    ],
...
export const testimonials = [
  {
    ...
    name: "Aman Gangwar",
    role: "President",
    avatarUrl: "/images/amanbhaiya.png",
    comment: "meri pyaari tech team",
  },
  {
    id: "1",
    name: "Mark Erixon",
  ...
  },
  {
    ...
    comment:
      " Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, magni tempore? Ut tempore deleniti rem amet nihil, consectetur nemo libero?",
  },
  {
    id: "3",
    name: "Alicia Barker",
